...
class MunicipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipe" do
    assert_difference("Municipe.count") do
      post municipes_url, params: { municipe: { birth: @municipe.birth, cns: @municipe.cns, cpf: @municipe.cpf, email: @municipe.email, name: @municipe.name, phone: @municipe.phone } }
    end
  ...
  test "should update municipe" do
    patch municipe_url(@municipe), params: { municipe: { birth: @municipe.birth, cns: @municipe.cns, cpf: @municipe.cpf, email: @municipe.email, name: @municipe.name, phone: @municipe.phone } }
